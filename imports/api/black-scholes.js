 ...
 * @param   {Date}   expiry  	Expiration date
 * @param   {String} right   	The type of option to be priced - "call" or "put"
 * @param   {Number} curr_price Current price of the option (midprice of spread)
 * @returns {Number}            Price of the option
 */
function Option(strike, expiry, right, curr_price) {
	this.strike = strike;
	this.expiry = expiry;
	this.right = right;
